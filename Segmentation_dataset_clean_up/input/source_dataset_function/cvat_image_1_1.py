...
LastEditors: Leidi
LastEditTime: 2021-11-29 10:38:09
'''
import os
import shutil
...
def copy_annotation(dataset: dict, root: str, n: str, prefix_number: int) -> None:
    ...
    temp_annotation = os.path.join(
        dataset['source_annotations_folder'], str(prefix_number) + dataset['prefix_delimiter'] + n)
