...
LastEditors: Leidi
LastEditTime: 2021-10-29 10:35:17
'''
import os
import shutil


def copy_images_annotations(dataset: dict, file_name: str, process_output, images_output_path: str, annotations_output_path: str) -> None:
    """[复制图片、数据至输出文件夹]
