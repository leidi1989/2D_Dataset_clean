...
LastEditors: Leidi
LastEditTime: 2022-01-10 16:56:03
'''
import os
import time
import yaml
...
if __name__ == "__main__":
    ...
    parser.add_argument('--config', '--c', dest='config', default=r'/home/leidi/hy_program/2D_Dataset_clean/Semantic_segmentation_dataset_clean_up/config/default.yaml',
